...
AWS_S3_UPLOADER_IAM_GROUP = config.get(SECTION, 'AWS_S3_UPLOADER_IAM_GROUP')
AWS_S3_UPLOADER_IAM_USERNAME_BASE = config.get(SECTION, 'AWS_S3_UPLOADER_IAM_USERNAME_BASE')
