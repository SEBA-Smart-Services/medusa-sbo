...
Revision ID: 80237cc6d863
Revises: 5e6e3fb61ac5
Create Date: 2017-05-31 16:30:48.273224
...
revision = '80237cc6d863'
down_revision = '5e6e3fb61ac5'
branch_labels = None
depends_on = None
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('alarm', sa.Column('xMedusa_ID', mysql.INTEGER(display_width=11), autoincrement=False, nullable=False))
